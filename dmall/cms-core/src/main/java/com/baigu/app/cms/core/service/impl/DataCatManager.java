...
import com.baigu.app.cms.core.service.ArticleCatRuntimeException;
...
public class DataCatManager implements IDataCatManager {
	...
	/* (non-Javadoc)
	 * @see IDataCatManager#add(DataCat)
	 */
...
//      判断文章分类不能同名
	...
	/* (non-Javadoc)
	 * @see IDataCatManager#delete(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataCatManager#edit(DataCat)
	 */
	@Transactional(propagation = Propagation.REQUIRED)
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataCatManager#saveSort(int[], int[])
	 */
	@Transactional(propagation = Propagation.REQUIRED)
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataCatManager#get(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataCatManager#listLevelChildren(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataCatManager#listAllChildren(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataCatManager#getParents(java.lang.Integer)
	 */
	@Override
