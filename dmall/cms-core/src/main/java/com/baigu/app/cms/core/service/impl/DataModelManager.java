...
public class DataModelManager implements IDataModelManager {
	...
	/* (non-Javadoc)
	 * @see IDataModelManager#add(DataModel)
	 */
...
/*		StringBuffer createTbSql= new StringBuffer("create table ");
	...
	/* (non-Javadoc)
	 * @see IDataModelManager#delete(java.lang.Integer)
	 */
	@Transactional(propagation = Propagation.REQUIRED)
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataModelManager#edit(DataModel)
	 */
	@Transactional(propagation = Propagation.REQUIRED)
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataModelManager#get(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataModelManager#checkIfModelInUse(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IDataModelManager#checkIfModelInUse(java.lang.String, java.lang.Integer)
	 */
	@Override
