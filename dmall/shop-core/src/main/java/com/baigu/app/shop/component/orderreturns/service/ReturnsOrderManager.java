package com.baigu.app.shop.component.orderreturns.service;
...
public class ReturnsOrderManager implements IReturnsOrderManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#add(ReturnsOrder, int, int, int[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#get(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#getByOrderSn(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#listAll(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#listMemberOrder()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#updateState(java.lang.Integer, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#refuse(java.lang.Integer, java.lang.String, int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#pageReturnOrder(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#getSnByOrderSn(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#updateOrderItemsState(java.lang.Integer, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#queryItemPrice(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#updateItemChange(java.lang.String, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#updateItemStatusByOrderidAndStatus(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#queryOrderidByReturnorderid(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#updatePriceByItemid(int, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#listAll(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#getOrderidByReturnid(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IReturnsOrderManager#updateItemsState(java.lang.Integer, int, int)
	 */
	@Override
