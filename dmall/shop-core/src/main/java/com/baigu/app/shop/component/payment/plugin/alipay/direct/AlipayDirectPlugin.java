package com.baigu.app.shop.component.payment.plugin.alipay.direct;
...
public class AlipayDirectPlugin extends AbstractPaymentPlugin implements IPaymentEvent,IPaymentQrCodeEvent {
	...
	/*
	 * (non-Javadoc)
	 * @see IPaymentQrCodeEvent#onPayQrCode(PayCfg, PayEnable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPaymentQrCodeEvent#onPayStatus(PayCfg, PayEnable)
	 */
	@Override
