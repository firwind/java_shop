...
public class GnotifyManager  implements IGnotifyManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IGnotifyManager#pageGnotify(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGnotifyManager#deleteGnotify(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGnotifyManager#addGnotify(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGnotifyManager#getGnotifyList(int, int)
	 */
	@Override
