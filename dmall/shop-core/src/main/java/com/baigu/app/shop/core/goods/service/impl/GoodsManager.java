...
public class GoodsManager implements IGoodsManager {
    ...
    /*
     * (non-Javadoc)
     * @see IGoodsManager#getGoodsEditData(java.lang.Integer)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
	 * @see IGoodsManager#get(java.lang.Integer)
	 */
    @Override
...
//		GoodsUtils.handleGoodsMap(goods);
    ...
    public List listGoods(String catid, String tagid, String goodsnum, String hot, String showhome) {
        ...
        if (!StringUtil.isEmpty(tagid)) {
            ...
            if (StringUtils.isNotBlank(showhome) && Integer.valueOf(showhome) == 1) {
                Integer tagId = this.daoSupport.queryForInt("SELECT tag_id FROM `es_tags` WHERE show_home=1 LIMIT 1");
        ...
        if (StringUtils.isNotBlank(hot)) {
            sql.append(" AND g.hot=" + Integer.valueOf(hot) + "");
        }
    ...
    /*
     * (non-Javadoc)
     * @see IGoodsManager#addPreviewGoods(Goods)
     */
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    ...
    /*
     * (non-Javadoc)
     * @see IGoodsManager#editPreviewGoods(Goods)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see IGoodsManager#getCountByGoodsIds(java.lang.Integer[])
     */
    @Override
