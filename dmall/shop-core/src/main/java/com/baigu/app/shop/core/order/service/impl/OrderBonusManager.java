...
public class OrderBonusManager implements IOrderBonusManager {
	...
	/* (non-Javadoc)
	 * @see IOrderBonusManager#getOrderBonus(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IOrderBonusManager#add(OrderBonus)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IOrderBonusManager#send_bonus(MemberBonus)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IOrderBonusManager#updateBonusReceivedNum(java.lang.Integer, java.lang.Integer)
	 */
	@Override
