...
public class ActivityGiftManager implements IActivityGiftManager{
	...
	/* (non-Javadoc)
	 * @see IActivityGiftManager#list(java.lang.String, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IActivityGiftManager#add(ActivityGift)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IActivityGiftManager#edit(ActivityGift)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IActivityGiftManager#get(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IActivityGiftManager#delete(java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see IActivityGiftManager#checkGiftInAct(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IActivityGiftManager#getGiftList()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IActivityGiftManager#getBonusList()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IActivityGiftManager#updateGiftStore(java.lang.Integer, java.lang.Integer, java.lang.Integer)
	 */
	@Override
