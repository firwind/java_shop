...
import com.baigu.app.shop.core.goods.plugin.goodsimp.GoodsImportPluginBundle;
 ...
 *
 */
public class GoodsDataBatchManager implements com.baigu.app.shop.core.goods.service.batchimport.IGoodsDataBatchManager {
...
//				goods.put("sn",sn);
			...
			for(int j=0;j<rowList.getLength();j++){
				...
				com.baigu.app.shop.core.goods.service.batchimport.IGoodsDataImporter goodsDataImporter = SpringContextHolder.getBean(importer);
