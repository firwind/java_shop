package com.baigu.app.shop.core.statistics.service.impl;
...
import com.baigu.app.shop.core.statistics.service.IGoodsStatisticsManager;
...
public class GoodsStatisticsManager  implements IGoodsStatisticsManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsStatisticsManager#getCollectList(int, int)
	 */
	@Override
