...
import com.baigu.app.shop.core.member.model.Favorite;
...
public class FavoriteManager implements IFavoriteManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#list(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#list(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#delete(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#add(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#getCount(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#getCount(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#delete(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#get(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#isFavorited(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IFavoriteManager#listGoods()
	 */
	@Override
