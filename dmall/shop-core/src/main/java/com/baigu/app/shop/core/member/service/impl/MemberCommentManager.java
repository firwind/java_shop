...
import com.baigu.app.shop.core.goods.plugin.GoodsCommentsBundle;
...
public class MemberCommentManager  implements IMemberCommentManager{
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#add(MemberComment)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getGoodsComments(int, int, int, int, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getGoodsComments(int, int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getGoodsGrade(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getAllComments(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#get(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#update(MemberComment)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#statistics(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getGoodsCommentsCount(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#delete(java.lang.Integer[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getMemberComments(int, int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getMemberCommentTotal(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getCommentsByStatus(int, int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#deletealone(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getCommentsCount(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getCommentsCount(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getCommentsGradeCount(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberCommentManager#getGoodsCommentsGradeList(int, int, int, int, int)
	 */
	@Override
