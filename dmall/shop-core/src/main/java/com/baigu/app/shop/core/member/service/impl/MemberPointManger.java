...
public class MemberPointManger   implements IMemberPointManger {
	...
	/*
	 *    (non-Javadoc)
	 * @see IMemberPointManger#checkIsOpen(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberPointManger#getItemPoint(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberPointManger#add(int, int, java.lang.String, java.lang.Integer, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberPointManger#useMarketPoint(int, int, java.lang.String, java.lang.Integer)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)  
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberPointManger#pointToPrice(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberPointManger#priceToPoint(java.lang.Double)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IMemberPointManger#addFreezePoint(java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IMemberPointManger#delFreezePoint(java.lang.Integer, java.lang.Integer)
	 */
	@Override
