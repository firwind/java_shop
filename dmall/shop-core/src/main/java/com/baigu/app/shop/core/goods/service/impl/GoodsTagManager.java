...
import com.baigu.app.shop.core.goods.service.IGoodsTagManager;
...
public class GoodsTagManager  implements IGoodsTagManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsTagManager#getGoodsList(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsTagManager#getGoodsList(int, int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsTagManager#addTag(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsTagManager#removeTag(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsTagManager#updateOrderNum(java.lang.Integer[], java.lang.Integer[], java.lang.Integer[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsTagManager#getGoodsList(int)
	 */
	@Override
