package com.baigu.app.shop.component.bonus.service.impl;
...
public class BonusManager  implements IBonusManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#sendForMemberLv(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#sendForOffLine(int, int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#list(int, int, int)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#getMemberBonusList(int, java.lang.Double, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#getGoodsList(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#exportToExcel(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#pageList(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#getBonus(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#getBonus(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#use(int, int, int, java.lang.String, int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)  
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#returned(int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)  
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#getMemberBonusList(int, java.lang.Double, java.lang.Integer, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IBonusManager#listBonus(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#getMemberNoUserBonusList(int, java.lang.Double, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#getMyUsableBonus(java.lang.Integer, java.lang.Double, int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IBonusManager#getMemberBonus(int)
	 */
	@Override
