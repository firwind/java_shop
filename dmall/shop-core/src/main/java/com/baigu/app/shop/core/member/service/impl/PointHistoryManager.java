...
public class PointHistoryManager implements IPointHistoryManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IPointHistoryManager#pagePointHistory(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPointHistoryManager#pagePointHistory(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPointHistoryManager#getConsumePoint(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPointHistoryManager#getGainedPoint(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPointHistoryManager#addPointHistory(PointHistory)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPointHistoryManager#listPointHistory(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPointHistoryManager#pagePointFreeze(int, int)
	 */
	@Override
