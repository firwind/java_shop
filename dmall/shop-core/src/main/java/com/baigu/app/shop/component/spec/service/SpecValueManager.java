...
public class SpecValueManager implements ISpecValueManager {
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecValueManager#add(SpecValue)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecValueManager#update(SpecValue)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecValueManager#list(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecValueManager#get(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecValueManager#checkSpecValue(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecValueManager#delInherentSpec(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecValueManager#selSpecValAndId(int, java.lang.String)
	 */
	@Override
