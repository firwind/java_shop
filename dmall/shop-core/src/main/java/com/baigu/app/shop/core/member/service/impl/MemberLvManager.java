...
public class MemberLvManager implements IMemberLvManager{
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#getDefaultLv()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#list(java.lang.String, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#get(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#delete(java.lang.Integer[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#list(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#getByPoint(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#getNextLv(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#getCatDiscountByLv(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#getHaveCatDiscountByLv(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#saveCatDiscountByLv(int[], int[], int)
	 */
	@Override
...
//			//System.out.println(sql);
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberLvManager#getHaveLvDiscountByCat(int)
	 */
	@Override
