package com.baigu.app.shop.component.product.plugin.order;
...
import com.baigu.app.shop.core.goods.service.StoreLogType;
import com.baigu.app.shop.core.order.model.Order;
import com.baigu.app.shop.core.order.plugin.order.IOrderCanelEvent;
import com.baigu.app.shop.core.order.plugin.order.IOrderItemSaveEvent;
...
import com.baigu.app.shop.core.order.plugin.order.IOrderChangeDepotEvent;
...
public class GenericOrderPlugin extends AutoRegisterPlugin implements IOrderShipEvent,IOrderCanelEvent,IOrderItemSaveEvent,IOrderChangeDepotEvent {
	...
	/*
	 * (non-Javadoc)
	 * @see IOrderItemSaveEvent#onItemSave(Order, OrderItem)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IOrderShipEvent#itemShip(Order, DeliveryItem)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IOrderCanelEvent#canel(Order)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see IOrderChangeDepotEvent#chaneDepot(Order, int, java.util.List)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see IOrderShipEvent#ship(Delivery, java.util.List)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IOrderShipEvent#canBeExecute(int)
	 */
	@Override
