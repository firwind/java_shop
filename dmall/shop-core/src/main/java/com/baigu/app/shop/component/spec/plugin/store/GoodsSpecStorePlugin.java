package com.baigu.app.shop.component.spec.plugin.store;
...
import com.baigu.app.shop.core.goods.plugin.IStoreSaveEvent;
...
public class GoodsSpecStorePlugin extends AbstractGoodsStorePlugin implements IGoodsDeleteEvent,IStockSaveEvent,IStoreSaveEvent {
	...
	/*
	 * (non-Javadoc)
	 * @see AbstractGoodsStorePlugin#getWarningStoreHtml(java.util.Map)
	 */
	@Override
