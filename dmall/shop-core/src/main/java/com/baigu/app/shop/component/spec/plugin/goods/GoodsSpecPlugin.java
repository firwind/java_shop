package com.baigu.app.shop.component.spec.plugin.goods;
...
import com.baigu.app.shop.component.spec.service.ISpecValueManager;
...
public class GoodsSpecPlugin extends AbstractGoodsPlugin implements IGoodsDeleteEvent,IGoodsTabShowEvent,IAjaxExecuteEnable{
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsBeforeAddEvent#onBeforeGoodsAdd(java.util.Map, javax.servlet.http.HttpServletRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsAfterEditEvent#onAfterGoodsEdit(java.util.Map, javax.servlet.http.HttpServletRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsBeforeEditEvent#onBeforeGoodsEdit(java.util.Map, javax.servlet.http.HttpServletRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsAfterAddEvent#onAfterGoodsAdd(java.util.Map, javax.servlet.http.HttpServletRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGetGoodsEditHtmlEvent#getEditHtml(java.util.Map, javax.servlet.http.HttpServletRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGetGoodsAddHtmlEvent#getAddHtml(javax.servlet.http.HttpServletRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsDeleteEvent#onGoodsDelete(java.lang.Integer[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsTabShowEvent#getTabName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IGoodsTabShowEvent#getOrder()
	 */
	@Override
	public int getOrder() {
		return 4;
