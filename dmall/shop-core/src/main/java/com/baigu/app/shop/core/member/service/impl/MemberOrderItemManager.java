...
public class MemberOrderItemManager implements IMemberOrderItemManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberOrderItemManager#add(MemberOrderItem)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberOrderItemManager#count(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberOrderItemManager#get(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberOrderItemManager#count(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberOrderItemManager#update(MemberOrderItem)
	 */
	@Override
...
//				memberOrderItem.getCommented(),memberOrderItem.getComment_time(),memberOrderItem.getId());
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberOrderItemManager#getGoodsList(int, int, int, int)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberOrderItemManager#getMemberOrderItem(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberOrderItemManager#getMemberOrderItemList(int, int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IMemberOrderItemManager#updateComment(MemberOrderItem)
	 */
	@Override
