...
public class ProductStoreManager implements IProductStoreManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IProductStoreManager#decreaseEnable(int, int, int, int)
	 */
	@Override
...
//		}
	...
	/*
	 * (non-Javadoc)
	 * @see IProductStoreManager#increaseEnable(int, int, int, int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
...
//		}
	...
	/*
	 * (non-Javadoc)
	 * @see IProductStoreManager#decreaseStroe(int, int, int, int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see IProductStoreManager#increaseStroe(int, int, int, int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
