...
import com.baigu.app.shop.core.goods.model.mapper.SpecValueMapper;
...
public class SpecManager  implements ISpecManager {
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecManager#add(Specification, java.util.List)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecManager#checkUsed(java.lang.Integer[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecManager#delete(java.lang.Integer[])
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)  
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecManager#edit(Specification, java.util.List)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)  
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecManager#listSpecAndValue()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecManager#listSpecAndValueByType(int)
	 */
	@Override
...
//		List valueList= this.daoSupport.queryForList(sql, new SpecValueMapper(), goodsTypeId);
	...
	/*
	 * (non-Javadoc)
	 * @see ISpecManager#get(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ISpecManager#listSpec(int, int)
	 */
	@Override
