...
import com.baigu.app.base.core.model.Role;
...
public class PermissionManager implements IPermissionManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IPermissionManager#giveRolesToUser(int, int[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPermissionManager#getUesrAct(int, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPermissionManager#getUesrAct(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPermissionManager#checkHaveAuth(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPermissionManager#getUserRoles(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPermissionManager#cleanUserRoles(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IPermissionManager#checkHaveRole(int, int)
	 */
	@Override
