...
import com.baigu.app.base.core.service.auth.IRoleManager;
...
public class RoleManager implements IRoleManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IRoleManager#edit(Role, int[])
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
