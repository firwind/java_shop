...
public class AuthActionManager   implements IAuthActionManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IAuthActionManager#add(AuthAction)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAuthActionManager#delete(int)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see IAuthActionManager#edit(AuthAction)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAuthActionManager#get(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAuthActionManager#addMenu(int, java.lang.Integer[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAuthActionManager#deleteMenu(int, java.lang.Integer[])
	 */
	@Override
