...
import com.baigu.app.base.core.service.IAdColumnManager;
import com.baigu.framework.annotation.Log;
import com.baigu.framework.util.StringUtil;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import com.baigu.app.base.core.model.AdColumn;
...
public class AdColumnManager implements IAdColumnManager {
	...
	/* (non-Javadoc)
	 * @see IAdColumnManager#addAdvc(AdColumn)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IAdColumnManager#delAdcs(java.lang.Integer[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IAdColumnManager#getADcolumnDetail(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IAdColumnManager#listAllAdvPos()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IAdColumnManager#pageAdvPos(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IAdColumnManager#updateAdvc(AdColumn)
	 */
	@Override
