package com.baigu.app.base.core.service.auth.impl;
...
import com.baigu.app.base.core.plugin.user.AdminUserPluginBundle;
...
import com.baigu.app.base.core.model.AuthAction;
...
public class AdminUserManagerImpl  implements IAdminUserManager {
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#add(AdminUser)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#add(int, int, AdminUser)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#checkLast()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#delete(java.lang.Integer)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#edit(AdminUser)
	 */
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#get(java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#list(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#listByRoleId(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#login(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#loginBySys(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see IAdminUserManager#is_exist(java.lang.String)
	 */
	@Override
